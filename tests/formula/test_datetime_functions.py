...
class TestHelperFunctions:
    ...
    def test_date_to_serial_leap_year_bug(self):
        ...
        serial = date_to_serial(datetime.date(1900, 3, 1))
        assert serial >= 61
    ...
    def test_time_to_serial_midnight(self):
        """Test midnight is 0."""
        serial = time_to_serial(datetime.time(0, 0, 0))
        assert serial == 0
