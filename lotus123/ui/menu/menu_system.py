...
class MenuSystem:
    ...
    def _build_main_menu(self) -> Menu:
        ...
        copy_menu = Menu("Copy")
        copy_menu.items = [
            MenuItem("C", "Copy", MenuAction.RANGE, handler=self._cmd_copy, help_text="Copy range")
        ]
        ...
        move_menu = Menu("Move")
        move_menu.items = [
            MenuItem("M", "Move", MenuAction.RANGE, handler=self._cmd_move, help_text="Move range")
        ]
        ...
        file_menu.items = [
            ...
            MenuItem(
                "S", "Save", MenuAction.INPUT, handler=self._cmd_file_save, help_text="Save file"
            ),
            MenuItem(
                "C",
                "Combine",
            ...
            MenuItem(
                "L", "List", MenuAction.COMMAND, handler=self._cmd_file_list, help_text="List files"
            ),
            MenuItem(
                "I",
                "Import",
        ...
        graph_menu.items = [
            ...
            MenuItem(
                "X", "X", MenuAction.RANGE, handler=self._cmd_graph_x, help_text="X-axis range"
            ),
            MenuItem(
                "A", "A", MenuAction.RANGE, handler=self._cmd_graph_a, help_text="First data range"
            ),
            MenuItem(
                "B", "B", MenuAction.RANGE, handler=self._cmd_graph_b, help_text="Second data range"
            ),
            MenuItem(
                "C", "C", MenuAction.RANGE, handler=self._cmd_graph_c, help_text="Third data range"
            ),
            MenuItem(
                "D", "D", MenuAction.RANGE, handler=self._cmd_graph_d, help_text="Fourth data range"
            ),
            MenuItem(
                "E", "E", MenuAction.RANGE, handler=self._cmd_graph_e, help_text="Fifth data range"
            ),
            MenuItem(
                "F", "F", MenuAction.RANGE, handler=self._cmd_graph_f, help_text="Sixth data range"
            ),
            MenuItem(
                "R",
                "Reset",
            ...
            MenuItem(
                "S", "Save", MenuAction.INPUT, handler=self._cmd_graph_save, help_text="Save graph"
            ),
            MenuItem(
                "O",
                "Options",
        ...
        data_menu.items = [
            MenuItem(
                "F", "Fill", MenuAction.RANGE, handler=self._cmd_data_fill, help_text="Fill range"
            ),
            MenuItem(
                "T",
                "Table",
        ...
        system_menu.items = [
            MenuItem(
                "S", "System", MenuAction.COMMAND, handler=self._cmd_system, help_text="OS shell"
            )
        ]
        ...
        quit_menu.items = [
            ...
            MenuItem(
                "N", "No", MenuAction.COMMAND, handler=self._cmd_quit_no, help_text="Cancel quit"
            ),
        ]
        ...
        main.items = [
            ...
            MenuItem(
                "R", "Range", MenuAction.SUBMENU, submenu=range_menu, help_text="Range operations"
            ),
            MenuItem("C", "Copy", MenuAction.SUBMENU, submenu=copy_menu, help_text="Copy cells"),
            ...
            MenuItem(
                "D", "Data", MenuAction.SUBMENU, submenu=data_menu, help_text="Database operations"
            ),
            MenuItem(
                "S", "System", MenuAction.SUBMENU, submenu=system_menu, help_text="System commands"
            ),
            MenuItem("Q", "Quit", MenuAction.SUBMENU, submenu=quit_menu, help_text="Exit program"),
        ]
    ...
    def _build_format_submenu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Fixed",
                MenuAction.INPUT,
                handler=self._cmd_format_fixed,
                help_text="Fixed decimals",
            ),
            MenuItem(
                "S",
                "Scientific",
                MenuAction.INPUT,
                handler=self._cmd_format_scientific,
                help_text="Scientific notation",
            ),
            MenuItem(
                "C",
                "Currency",
                MenuAction.INPUT,
                handler=self._cmd_format_currency,
                help_text="Currency format",
            ),
            MenuItem(
                ",", ",", MenuAction.INPUT, handler=self._cmd_format_comma, help_text="Comma format"
            ),
            MenuItem(
                "G",
                "General",
                MenuAction.COMMAND,
                handler=self._cmd_format_general,
                help_text="General format",
            ),
            MenuItem(
                "+",
                "+/-",
                MenuAction.COMMAND,
                handler=self._cmd_format_plusminus,
                help_text="Bar graph format",
            ),
            MenuItem(
                "P",
                "Percent",
                MenuAction.INPUT,
                handler=self._cmd_format_percent,
                help_text="Percentage format",
            ),
            MenuItem(
                "D",
                "Date",
                MenuAction.SUBMENU,
                submenu=self._build_date_format_menu(),
            ...
            MenuItem(
                ...
                "Text",
                MenuAction.COMMAND,
                handler=self._cmd_format_text,
                help_text="Text format",
            ),
            MenuItem(
                "H",
                "Hidden",
                MenuAction.COMMAND,
                handler=self._cmd_format_hidden,
                help_text="Hidden format",
            ),
            MenuItem(
                "R",
                "Reset",
                MenuAction.COMMAND,
                handler=self._cmd_format_reset,
                help_text="Reset to default",
            ),
        ]
        return menu
    ...
    def _build_date_format_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "DD-MMM-YY",
                MenuAction.COMMAND,
                handler=lambda: self._cmd_date_format(1),
                help_text="26-Dec-91",
            ),
            MenuItem(
                "2",
                "DD-MMM",
                MenuAction.COMMAND,
                handler=lambda: self._cmd_date_format(2),
                help_text="26-Dec",
            ),
            MenuItem(
                "3",
                "MMM-YY",
                MenuAction.COMMAND,
                handler=lambda: self._cmd_date_format(3),
                help_text="Dec-91",
            ),
            MenuItem(
                "4",
                "MM/DD/YY",
                MenuAction.COMMAND,
                handler=lambda: self._cmd_date_format(4),
                help_text="12/26/91",
            ),
            MenuItem(
                "5",
                "MM/DD",
                MenuAction.COMMAND,
                handler=lambda: self._cmd_date_format(5),
                help_text="12/26",
            ),
        ]
        return menu
    ...
    def _build_label_prefix_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Left",
                MenuAction.COMMAND,
                handler=self._cmd_label_left,
                help_text="Left align ('prefix)",
            ),
            MenuItem(
                "R",
                "Right",
                MenuAction.COMMAND,
                handler=self._cmd_label_right,
                help_text='Right align ("prefix)',
            ),
            MenuItem(
                "C",
                "Center",
                MenuAction.COMMAND,
                handler=self._cmd_label_center,
                help_text="Center (^prefix)",
            ),
        ]
        return menu
    ...
    def _build_recalc_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Natural",
                MenuAction.COMMAND,
                handler=self._cmd_recalc_natural,
                help_text="Natural order",
            ),
            MenuItem(
                "C",
                "Columnwise",
                MenuAction.COMMAND,
                handler=self._cmd_recalc_columnwise,
                help_text="Column order",
            ),
            MenuItem(
                "R",
                "Rowwise",
                MenuAction.COMMAND,
                handler=self._cmd_recalc_rowwise,
                help_text="Row order",
            ),
            MenuItem(
                "A",
                "Automatic",
                MenuAction.COMMAND,
                handler=self._cmd_recalc_automatic,
                help_text="Auto recalc",
            ),
            MenuItem(
                "M",
                "Manual",
                MenuAction.COMMAND,
                handler=self._cmd_recalc_manual,
                help_text="Manual recalc",
            ),
            MenuItem(
                "I",
                "Iteration",
    ...
    def _build_default_menu(self) -> Menu:
        ...
        menu = Menu("Default")
        menu.items = [
            MenuItem("P", "Printer", MenuAction.SUBMENU, help_text="Default printer settings"),
            MenuItem(
                "D",
                "Directory",
                MenuAction.INPUT,
                handler=self._cmd_default_directory,
                help_text="Default directory",
            ),
            MenuItem(
                "S",
                "Status",
                MenuAction.COMMAND,
                handler=self._cmd_default_status,
                help_text="Show defaults",
            ),
            MenuItem(
                "U",
                "Update",
                MenuAction.COMMAND,
                handler=self._cmd_default_update,
                help_text="Save defaults",
            ),
            MenuItem("O", "Other", MenuAction.SUBMENU, help_text="Other settings"),
        ]
        return menu
    ...
    def _build_zero_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Yes",
                MenuAction.COMMAND,
                handler=self._cmd_zero_yes,
                help_text="Display zeros",
            ),
            MenuItem(
                "N", "No", MenuAction.COMMAND, handler=self._cmd_zero_no, help_text="Suppress zeros"
            ),
            MenuItem(
                "L", "Label", MenuAction.INPUT, handler=self._cmd_zero_label, help_text="Zero label"
            ),
        ]
        return menu
    ...
    def _build_insert_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                "R", "Row", MenuAction.COMMAND, handler=self._cmd_insert_row, help_text="Insert row"
            ),
            MenuItem(
                "C",
                "Column",
                MenuAction.COMMAND,
                handler=self._cmd_insert_column,
                help_text="Insert column",
            ),
        ]
        return menu
    ...
    def _build_delete_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                "R", "Row", MenuAction.COMMAND, handler=self._cmd_delete_row, help_text="Delete row"
            ),
            MenuItem(
                "C",
                "Column",
                MenuAction.COMMAND,
                handler=self._cmd_delete_column,
                help_text="Delete column",
            ),
        ]
        return menu
    ...
    def _build_column_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Set-Width",
                MenuAction.INPUT,
                handler=self._cmd_column_setwidth,
                help_text="Set column width",
            ),
            MenuItem(
                "R",
                "Reset-Width",
                MenuAction.COMMAND,
                handler=self._cmd_column_resetwidth,
                help_text="Reset to default",
            ),
            MenuItem(
                "H",
                "Hide",
                MenuAction.COMMAND,
                handler=self._cmd_column_hide,
                help_text="Hide column",
            ),
            MenuItem(
                "D",
                "Display",
                MenuAction.COMMAND,
                handler=self._cmd_column_display,
                help_text="Show column",
            ),
        ]
        return menu
    ...
    def _build_titles_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Both",
                MenuAction.COMMAND,
                handler=self._cmd_titles_both,
                help_text="Freeze rows and columns",
            ),
            MenuItem(
                "H",
                "Horizontal",
                MenuAction.COMMAND,
                handler=self._cmd_titles_horizontal,
                help_text="Freeze rows",
            ),
            MenuItem(
                "V",
                "Vertical",
                MenuAction.COMMAND,
                handler=self._cmd_titles_vertical,
                help_text="Freeze columns",
            ),
            MenuItem(
                "C",
                "Clear",
                MenuAction.COMMAND,
                handler=self._cmd_titles_clear,
                help_text="Unfreeze all",
            ),
        ]
        return menu
    ...
    def _build_window_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Horizontal",
                MenuAction.COMMAND,
                handler=self._cmd_window_horizontal,
                help_text="Split horizontally",
            ),
            MenuItem(
                "V",
                "Vertical",
                MenuAction.COMMAND,
                handler=self._cmd_window_vertical,
                help_text="Split vertically",
            ),
            MenuItem(
                "S",
                "Sync",
                MenuAction.COMMAND,
                handler=self._cmd_window_sync,
                help_text="Sync scrolling",
            ),
            MenuItem(
                "U",
                "Unsync",
                MenuAction.COMMAND,
                handler=self._cmd_window_unsync,
                help_text="Unsync scrolling",
            ),
            MenuItem(
                "C",
                "Clear",
                MenuAction.COMMAND,
                handler=self._cmd_window_clear,
                help_text="Remove split",
            ),
        ]
        return menu
    ...
    def _build_label_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Left",
                MenuAction.RANGE,
                handler=self._cmd_label_range_left,
                help_text="Left align",
            ),
            MenuItem(
                "R",
                "Right",
                MenuAction.RANGE,
                handler=self._cmd_label_range_right,
                help_text="Right align",
            ),
            MenuItem(
                "C",
                "Center",
                MenuAction.RANGE,
                handler=self._cmd_label_range_center,
                help_text="Center",
            ),
        ]
        return menu
    ...
    def _build_name_menu(self) -> Menu:
        ...
        menu.items = [
            ...
            MenuItem(
                ...
                "Labels",
                MenuAction.SUBMENU,
                submenu=self._build_name_labels_menu(),
                help_text="Create from labels",
            ),
            MenuItem(
                "R",
                "Reset",
                MenuAction.COMMAND,
                handler=self._cmd_name_reset,
                help_text="Delete all names",
            ),
            MenuItem(
                "T",
                "Table",
                MenuAction.COMMAND,
                handler=self._cmd_name_table,
                help_text="List names",
            ),
        ]
        return menu
    ...
    def _build_name_labels_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Right",
                MenuAction.RANGE,
                handler=self._cmd_name_labels_right,
                help_text="Names from left column",
            ),
            MenuItem(
                "D",
                "Down",
                MenuAction.RANGE,
                handler=self._cmd_name_labels_down,
                help_text="Names from top row",
            ),
            MenuItem(
                "L",
                "Left",
                MenuAction.RANGE,
                handler=self._cmd_name_labels_left,
                help_text="Names from right column",
            ),
            MenuItem(
                "U",
                "Up",
    ...
    def _build_combine_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Copy",
                MenuAction.INPUT,
                handler=self._cmd_combine_copy,
                help_text="Copy entire file",
            ),
            MenuItem(
                "A", "Add", MenuAction.INPUT, handler=self._cmd_combine_add, help_text="Add values"
            ),
            MenuItem(
                "S",
                "Subtract",
                MenuAction.INPUT,
                handler=self._cmd_combine_subtract,
                help_text="Subtract values",
            ),
        ]
        return menu
    ...
    def _build_extract_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Formulas",
                MenuAction.INPUT,
                handler=self._cmd_extract_formulas,
                help_text="Extract with formulas",
            ),
            MenuItem(
                "V",
                "Values",
                MenuAction.INPUT,
                handler=self._cmd_extract_values,
                help_text="Extract values only",
            ),
        ]
        return menu
    ...
    def _build_import_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Text",
                MenuAction.INPUT,
                handler=self._cmd_import_text,
                help_text="Import text file",
            ),
            MenuItem(
                "N",
                "Numbers",
    ...
    def _build_graph_type_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Line",
                MenuAction.COMMAND,
                handler=self._cmd_graph_type_line,
                help_text="Line chart",
            ),
            MenuItem(
                "B",
                "Bar",
                MenuAction.COMMAND,
                handler=self._cmd_graph_type_bar,
                help_text="Bar chart",
            ),
            MenuItem(
                "X",
                "XY",
                MenuAction.COMMAND,
                handler=self._cmd_graph_type_xy,
                help_text="XY scatter",
            ),
            MenuItem(
                "S",
                "Stacked-Bar",
                MenuAction.COMMAND,
                handler=self._cmd_graph_type_stacked,
                help_text="Stacked bar",
            ),
            MenuItem(
                "P",
                "Pie",
                MenuAction.COMMAND,
                handler=self._cmd_graph_type_pie,
                help_text="Pie chart",
            ),
        ]
        return menu
    ...
    def _build_graph_options_menu(self) -> Menu:
        ...
        menu = Menu("Options")
        menu.items = [
            MenuItem("L", "Legend", MenuAction.SUBMENU, help_text="Legend settings"),
            MenuItem("F", "Format", MenuAction.SUBMENU, help_text="Format settings"),
            MenuItem("T", "Titles", MenuAction.SUBMENU, help_text="Chart titles"),
            MenuItem("G", "Grid", MenuAction.SUBMENU, help_text="Grid lines"),
            MenuItem("S", "Scale", MenuAction.SUBMENU, help_text="Scale settings"),
            MenuItem("C", "Color", MenuAction.SUBMENU, help_text="Color/B&W"),
            MenuItem("D", "Data-Labels", MenuAction.SUBMENU, help_text="Data labels"),
        ]
        return menu
    ...
    def _build_graph_name_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Use",
                MenuAction.INPUT,
                handler=self._cmd_graph_name_use,
                help_text="Use named graph",
            ),
            MenuItem(
                "C",
                "Create",
                MenuAction.INPUT,
                handler=self._cmd_graph_name_create,
                help_text="Create named graph",
            ),
            MenuItem(
                "D",
                "Delete",
                MenuAction.INPUT,
                handler=self._cmd_graph_name_delete,
                help_text="Delete named graph",
            ),
            MenuItem(
                "R",
                "Reset",
                MenuAction.COMMAND,
                handler=self._cmd_graph_name_reset,
                help_text="Delete all graphs",
            ),
        ]
        return menu
    ...
    def _build_data_table_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "1",
                MenuAction.RANGE,
                handler=self._cmd_data_table1,
                help_text="One-variable table",
            ),
            MenuItem(
                "2",
                "2",
                MenuAction.RANGE,
                handler=self._cmd_data_table2,
                help_text="Two-variable table",
            ),
            MenuItem(
                "R",
                "Reset",
                MenuAction.COMMAND,
                handler=self._cmd_data_table_reset,
                help_text="Reset table",
            ),
        ]
        return menu
    ...
    def _build_data_sort_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Data-Range",
                MenuAction.RANGE,
                handler=self._cmd_sort_data_range,
                help_text="Data to sort",
            ),
            MenuItem(
                "P",
                "Primary-Key",
                MenuAction.RANGE,
                handler=self._cmd_sort_primary_key,
                help_text="Primary sort key",
            ),
            MenuItem(
                "S",
                "Secondary-Key",
                MenuAction.RANGE,
                handler=self._cmd_sort_secondary_key,
                help_text="Secondary sort key",
            ),
            MenuItem(
                "R",
                "Reset",
                MenuAction.COMMAND,
                handler=self._cmd_sort_reset,
                help_text="Reset sort settings",
            ),
            MenuItem(
                "G", "Go", MenuAction.COMMAND, handler=self._cmd_sort_go, help_text="Execute sort"
            ),
        ]
        return menu
    ...
    def _build_data_query_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Input",
                MenuAction.RANGE,
                handler=self._cmd_query_input,
                help_text="Input range",
            ),
            MenuItem(
                "C",
                "Criterion",
                MenuAction.RANGE,
                handler=self._cmd_query_criterion,
                help_text="Criteria range",
            ),
            MenuItem(
                "O",
                "Output",
                MenuAction.RANGE,
                handler=self._cmd_query_output,
                help_text="Output range",
            ),
            MenuItem(
                "F",
                "Find",
                MenuAction.COMMAND,
                handler=self._cmd_query_find,
                help_text="Find matching",
            ),
            MenuItem(
                "E",
                "Extract",
                MenuAction.COMMAND,
                handler=self._cmd_query_extract,
                help_text="Extract records",
            ),
            MenuItem(
                "U",
                "Unique",
                MenuAction.COMMAND,
                handler=self._cmd_query_unique,
                help_text="Unique records",
            ),
            MenuItem(
                "D",
                "Delete",
                MenuAction.COMMAND,
                handler=self._cmd_query_delete,
                help_text="Delete matching",
            ),
            MenuItem(
                "R",
                "Reset",
                MenuAction.COMMAND,
                handler=self._cmd_query_reset,
                help_text="Reset query settings",
            ),
        ]
        return menu
    ...
    def _build_data_matrix_menu(self) -> Menu:
        ...
        menu.items = [
            MenuItem(
                ...
                "Invert",
                MenuAction.RANGE,
                handler=self._cmd_matrix_invert,
                help_text="Invert matrix",
            ),
            MenuItem(
                "M",
                "Multiply",
                MenuAction.RANGE,
                handler=self._cmd_matrix_multiply,
                help_text="Multiply matrices",
            ),
        ]
        return menu
    ...
    def go_back(self) -> bool:
        ...
        if self.context.state in (
            MenuState.AWAITING_INPUT,
            MenuState.AWAITING_RANGE,
